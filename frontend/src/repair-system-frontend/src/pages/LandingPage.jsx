...
const features = [
  {
    ...
    description: "Sprawna rejestracja zgłoszeń i szybka diagnoza pozwalają ograniczyć czas oczekiwania na rozpoczęcie naprawy.",
  },
  {
    number: "02",
    title: "Śledzenie statusu naprawy",
    description: "Klient może w każdej chwili sprawdzić, na jakim etapie znajduje się urządzenie i co dzieje się z naprawą.",
  },
  {
    number: "03",
    title: "Przejrzysta komunikacja",
    description: "Jasne informacje o postępie, kosztach i terminach sprawiają, że cały proces jest prosty i zrozumiały.",
  },
  {
    number: "04",
    title: "Wygodny odbiór sprzętu",
    description: "Po zakończeniu naprawy klient otrzymuje wiadomość i od razu wie, kiedy może odebrać gotowe urządzenie.",
  },
];
...
const workflowSteps = [
  {
    number: "01",
    title: "Oddaj sprzęt",
    description: "Przekaż urządzenie do serwisu i poczekaj na ocenę uszkodzenia. Technik sprawdzi stan sprzętu i określi zakres naprawy.",
  },
  {
    number: "02",
    title: "Otrzymaj dane do śledzenia",
    description: "Po przyjęciu zlecenia dostaniesz dane do śledzenia naprawy, aby na bieżąco sprawdzać postęp online.",
  },
  {
    number: "03",
    title: "Odbierz gotowy sprzęt",
    description: "Gdy naprawa zostanie zakończona, otrzymasz wiadomość o możliwości odbioru gotowego, naprawionego urządzenia.",
  },
];
  ...
  [
    {
      ...
      quote: "Laptop został przyjęty bardzo sprawnie, a już tego samego dnia dostałam informację o diagnozie i kolejnych krokach.",
      name: "Anna Kowalska",
    ...
    },
    {
      ...
      quote: "Najbardziej doceniam to, że mogłem na bieżąco sprawdzać status naprawy online, bez dzwonienia i dopytywania o szczegóły.",
      name: "Michał Nowak",
    ...
    },
    {
      ...
      quote: "Kiedy urządzenie było gotowe, od razu dostałam wiadomość. Cały proces przebiegł spokojnie, jasno i bardzo profesjonalnie.",
  ...
  [
    {
      ...
      quote: "Bardzo doceniam szybki kontakt po oddaniu sprzętu. Od razu wiedziałem, co wymaga naprawy i jaki będzie następny krok.",
      name: "Paweł Krawczyk",
    ...
    },
    {
      ...
      quote: "Status naprawy, przewidywany termin i kontakt z serwisem były naprawdę przejrzyste. Nie musiałam niczego zgadywać.",
      name: "Natalia Wójcik",
  ...
  [
    {
      ...
      quote: "Za każdym razem wiedziałam, co dzieje się ze sprzętem. Informacje przychodziły na czas i były napisane bardzo jasno.",
    ...
    },
    {
      ...
      quote: "Serwis działa sprawnie, a system napraw naprawdę pomaga uporządkować cały proces. Wszystko wygląda nowocześnie i konkretnie.",
    ...
    },
    {
      ...
      quote: "Największy plus to poczucie kontroli nad naprawą. Możliwość śledzenia statusu i szybkie powiadomienia robią świetne wrażenie.",
      name: "Ewa Mazur",
          ...
          <div className="hero-banner">
            ...
            <header className="hero-navbar">
              <div className="hero-navbar-inner">
                ...
                <nav className="nav-links">
                  <a href="#home" onClick={openSection("home")}>Start</a>
                  <a href="#how" onClick={openSection("how")}>Jak działa</a>
                  <a href="#features" onClick={openSection("features")}>Nasze zalety</a>
            ...
            <div className="hero-card">
              ...
              <div className="hero-buttons">
                <button type="button" className="btn btn-primary" onClick={openSection("search")}>
