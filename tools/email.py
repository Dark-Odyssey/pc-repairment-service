...
class EmailHandler: 
    ...
    async def send_token_link(self, user_email: str, token: str) -> None:
        ...
        await self.__send_email(email=email, to_email=user_email)


    async def send_new_status(self, order_number: str, user_email: str) -> None:
        email = EmailMessage()
    ...
    async def send_repair_order_creds(self, user_email: str, order_number: str, access_code: str):
        email = EmailMessage()
